...
static byte selectPin = WAL6;
static byte MOSI = WAL4;
static byte MISO = WAL3;
static byte SCK = WAL5;
...
byte ENC28J60::initialize (word size, const byte* macaddr, byte csPin, byte sckPin, byte mosiPin, byte misoPin) {
    bufferSize = size;
