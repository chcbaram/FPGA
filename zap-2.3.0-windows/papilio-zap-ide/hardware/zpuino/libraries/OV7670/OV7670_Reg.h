...
/*
static const struct regval_list ov7670_setup_regs[] = {//from the linux driver
	...
	{ 0x12, 0x04 }, // COM7   QIF + RGB output	
	{ 0x11, 0x00 }, // CLKRC  Prescaler - Fin/(1+1)
	{ 0x0C, 0x04 }, // COM3  Lots of stuff, enable scaling, all others off
	{ 0x3E, 0x19 }, // COM14  PCLK scaling = 0
	{ 0x40, 0x10 }, // 
	{ 0x3a, 0x04 }, // 
	{ 0x8C, 0x00 }, // 
	{ 0x17, 0x14 }, // 
